              ...
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-lg text-sm font-medium transition-colors ${
                  selectedCategory === category
                    ? 'text-[var(--color-primary)] font-bold border border-[var(--color-border)]'
                    : 'text-[var(--color-text-secondary)] hover:font-bold hover:text-[var(--color-text-primary)] hover:bg-[var(--color-secondary)]/10'
                }`}
              >
                {category}
              </button>
