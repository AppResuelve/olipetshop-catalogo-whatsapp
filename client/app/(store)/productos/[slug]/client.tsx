...
export default function ProductDetailClient({ product }: { product: any }) {
  ...
  return (
    <section
      className="bg-white pb-24 px-4 sm:px-6 lg:px-8"
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-24">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-6" aria-hidden="true">
              <div className="h-1 w-12 rounded-full" style={{ backgroundColor: "var(--color-secondary)" }} />
              <div className="h-1 w-4 rounded-full" style={{ backgroundColor: "var(--color-primary)" }} />
            </div>
            ...
            <button
              ...
              style={{
                ...
                color: "var(--color-text-primary)",
                boxShadow: "0 4px 16px rgba(239,242,58,0.35)",
              }}
            >
              {justAdded ? (
                <>
