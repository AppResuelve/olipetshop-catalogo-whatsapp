    ...
    },
    {
      ...
      accessor: (s) => (
        <div className="flex items-center gap-1">
          <button onClick={(e) => { e.stopPropagation(); navigate(`/dashboard/services/${s.id}/edit`) }} className="p-1.5 rounded-lg text-zinc-500 hover:text-cyan-400 hover:bg-cyan-500/10 transition-colors">
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <Table
        columns={columns}
        data={services}
        onRowClick={(s) => navigate(`/dashboard/services/${s.id}/edit`)}
