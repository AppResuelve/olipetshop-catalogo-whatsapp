...
export default function Store() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-md">
          ...
          <p className="text-sm text-zinc-600 mt-1">Agregá VITE_STORE_URL en el .env del cliente</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div
        ref={containerRef}
        className="relative rounded-xl overflow-hidden border border-zinc-800 mb-6 bg-zinc-900"
      >
